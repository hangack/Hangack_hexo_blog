...
```
<img src="/images/주피터 경로 변경/J1.png" alt="config">

그러면 user 경로 .jupyter 디렉토리에 jupyter_notebook_config.py 파일이 생성된다.

<img src="/images/주피터 경로 변경/J2.png" alt="">

버전마다 다르지만 에디터를 이용해 385번줄에 있는
```python
# c.NotebookApp.notebook_dir = ''
```
<img src="/images/주피터 경로 변경/J3.png" alt="">
...
시작위치: %HOMEPATH%
```
<img src="/images/주피터 경로 변경/J6.png" alt="">
